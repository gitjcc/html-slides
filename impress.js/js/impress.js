...
( function( document, window ) {
    ...
    // Yes, this means you can have more than one instance on a pages, but I'm not
    ...
    var impress = window.impress = function( rootId ) {
        ...
        // If a number is given, step with homepage given by the number is returned, if a string
        ...
        // (by homepage, id or element), with a transition `duration` optionally
        ...
        var goto = function( el, duration ) {
            ...
            // Browser in such a case tries to scroll the pages to make this element visible
            // (even that body overflow is set to hidden) and it breaks our careful positioning.
            //
            // So, as a lousy (and lazy) workaround we will make the pages scroll back to the top
